...
def main():
    ...
    parser.add_argument('-param', type=int, default=None, help='additional parameter for model_saving')
    args = parser.parse_args()
    saving_param = args.param
    opt = option.parse(parser.parse_args().opt, saving_param)
    ...
    for epoch in range(start_epoch, NUM_EPOCH + 1):
        ...
        solver.save_checkpoint(epoch, epoch_is_best, saving_param)

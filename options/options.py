...
def parse(opt_path,saving_param):
    ...
    config_str = 'experiments'
    exp_path = os.path.join(os.getcwd(), config_str)
    exp_path = os.path.join(exp_path, f"Cam{saving_param}_experiments")
